...
router.get('/github/:username', (req, res) => {
    const options = {
        uri: `https://api.github.com/users/${req.params.username}/repos?per_page_5&sort=created:asc&client_id=${process.env.clientid||config.get('clientid')}&client_secret=${process.env.clientsecret||config.get('clientsecret')}`,
        method: 'GET',
